...
#define PHP_XML2ARRAY_VERSION "0.1.0" /* Replace with version number for your extension */
...
/* Always refer to the globals in your function as XML2ARRAY_G(variable).
   You are encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/
#define XML2ARRAY_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(xml2array, v)

#if defined(ZTS) && defined(COMPILE_DL_XML2ARRAY)
